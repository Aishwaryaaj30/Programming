// Write a program which checks whether 7th & 18th bit is On or Off
...
//  Input           :   int
//  Output          :   boolean
//  Description     :   To check 7th & 18th bit is on or off
//  Date            :   30/06/2026
...
class Bitwise
{
                           ...
                           )
    {
        ...
        int iPos2 = 18;                     // Variable to store bit position

        int iResult = 0;                    // Variable to store result

        iMask1 = iMask1 << (iPos1 - 1);     // Shift mask to the 7th bit position
        iMask2 = iMask2 << (iPos2 - 1);     // Shift mask to the 18th bit position
...
////////////////////////////////////////////////////////////////////////////////////////////////
//  
//  Application to display 7th & 18th bit is On or Off
//
////////////////////////////////////////////////////////////////////////////////////////////////
