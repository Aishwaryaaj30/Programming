...
// Input            :   PNODE, int
// Output           :   bool
// Description      :   To count frequency of given numbers
// Date             :   07/07/2026 
// Author           :   Aishwarya Mohan Jadhav       
//
///////////////////////////////////////////////////////////////////////////////////////
...
int CountFrequency(
                        PNODE first,        // Points to the first node 
                        int iNo             // Number of frequency to be count
                  )
{
    int iFreq = 0;                          // Variable to store count of frequency
...
///////////////////////////////////////////////////////////////////////////////////////
//
// Application to count frequency of numbers in Linked List
//
///////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    iRet = CountFrequency(head, 51);        // Function call
