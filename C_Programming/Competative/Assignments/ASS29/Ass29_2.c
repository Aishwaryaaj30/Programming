...
// Input            :   PNODE
// Output           :   int
// Description      :   To count even numbers
// Date             :   07/07/2026 
// Author           :   Aishwarya Mohan Jadhav       
//
///////////////////////////////////////////////////////////////////////////////////////
             ...
             )
{
    ...
    {
        if((first -> data % 2) == 0)        // Operation for even
        {
            iCount++;
        }
        first = first -> next;              // Go to next node
...
///////////////////////////////////////////////////////////////////////////////////////
//
// Application to count even numbers in Linked List
//
///////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    iRet = CountEven(head);                 // Function call
