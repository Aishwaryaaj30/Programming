...
// Input            :   PNODE, int
// Output           :   int
// Description      :   To count number smaller than ino
// Date             :   07/07/2026 
// Author           :   Aishwarya Mohan Jadhav       
//
///////////////////////////////////////////////////////////////////////////////////////
             ...
             )
{
    ...
    {
        if((first -> data) < iNo)           // To check less
        {
            iCount++;
        }
        first = first -> next;              // Go to next node
...
///////////////////////////////////////////////////////////////////////////////////////
//
// Application to count numbers less than X from Linked List
//
///////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Number smaller than 20 are : %d\n", iRet);
