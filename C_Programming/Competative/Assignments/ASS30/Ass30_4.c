...
// Input            :   PNODE, int
// Output           :   int
// Description      :   To count number greater than ino
// Date             :   07/07/2026 
// Author           :   Aishwarya Mohan Jadhav       
//
///////////////////////////////////////////////////////////////////////////////////////
                ...
                )
{
    ...
    {
        if((first -> data) > iNo)           // To check greater
        {
            iCount++;
        }
        first = first -> next;              // Go to next node
...
///////////////////////////////////////////////////////////////////////////////////////
//
// Application to count numbers greater than X  from Linked List
//
///////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    printf("Number greater than 20 are : %d\n", iRet);
